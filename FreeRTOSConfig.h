...
#define tskIDLE_STACK_SIZE                  24
#define configMINIMAL_STACK_SIZE            128/* This value is in words (memory usage is n*4 bytes) */
#define configTOTAL_HEAP_SIZE               4000 /* This value is in bytes */
